      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 relative z-10">
        {briefs.length === 0 ? (
          <div className="col-span-full text-center py-32 bg-[var(--bg-card)] border border-[var(--border-default)] rounded-[2.5rem] shadow-2xl">
            ...
            <button onClick={() => navigate("/brand/ugc/post")} className="bg-white text-black font-bold px-8 py-3.5 rounded-full text-sm hover:bg-[var(--bg-elevated)] transition-colors shadow-lg active:scale-95">Create Brief</button>
          </div>
        ) : briefs.map(b => (
                 ...
                 <div className="bg-[var(--bg-card)] p-6 flex-1 flex flex-col justify-end">
                   <div>
                      ...
                      <div className="flex gap-3 pt-6 border-t border-[var(--border-default)]">
                         ...
                         <button className="flex-1 bg-[var(--bg-card)] hover:bg-[#252530] text-[var(--text-secondary)] hover:text-[var(--text-primary)]/80 text-xs font-bold py-3 rounded-xl transition-colors border border-transparent">Pause</button>
                      </div>
                   </div>
                 </div>
              </div>
