...
export default function BrandUGCPost() {
  ...
  const Step1 = () => (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
      ...
      <button onClick={() => setStep(2)} className="w-full bg-white hover:bg-[var(--bg-surface)] text-black font-bold py-4 rounded-xl mt-4 active:scale-95 transition-all shadow-xl">Next: Product Info</button>
    </div>
  );
  ...
  const Step2 = () => (
    <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="flex gap-3 pt-2">
         ...
         <button onClick={() => setStep(3)} className="w-2/3 bg-white hover:bg-[var(--bg-surface)] text-black font-bold py-3.5 rounded-xl active:scale-95 transition-all mb-4 shadow-xl">Next: Deliverables</button>
      </div>
    </div>
  );
  ...
  const Step3 = () => (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="flex gap-3 pt-4">
         ...
         <button onClick={() => setStep(4)} className="w-2/3 bg-white hover:bg-[var(--bg-surface)] text-black font-bold py-3.5 rounded-xl active:scale-95 transition-all shadow-xl">Next: Budget</button>
      </div>
    </div>
  );
  ...
  const Step4 = () => (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="flex gap-3 pt-8">
         ...
         <button onClick={() => setStep(5)} className="w-2/3 bg-white hover:bg-[var(--bg-surface)] text-black font-bold py-3.5 rounded-xl active:scale-95 transition-all shadow-xl">Review & Pay</button>
      </div>
    </div>
  );
  ...
  const Step5 = () => (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
      <div className="bg-[var(--bg-card)] rounded-3xl p-6 border border-[#27273a] shadow-xl">
           ...
           <div className="w-full rounded-[2.5rem] overflow-hidden relative shadow-2xl bg-[var(--bg-card)] border border-[var(--border-default)] aspect-[9/16]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/90 via-black/50 to-transparent z-20">
                 <div className="flex flex-wrap items-center gap-2 mb-4">
                    ...
                    <div className="bg-white/20 backdrop-blur-md text-[var(--text-primary)] px-3.5 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider">
