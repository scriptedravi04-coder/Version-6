...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-background text-foreground" data-testid="signup-page">
      ...
      <section className="lg:col-span-5 flex flex-col justify-center items-center pt-24 sm:pt-12 pb-12 px-6 sm:p-12 md:p-16 lg:p-24 bg-background min-h-screen">
        <div className="w-full max-w-sm sm:max-w-md mx-auto animate-in fade-in slide-in-from-right-4 duration-300">
          <div className="mb-6 sm:mb-8 text-center sm:text-left">
            <h1 className="font-display text-2xl sm:text-3xl lg:text-4xl text-foreground font-bold tracking-tight">Create your account</h1>
            <p className="text-foreground/60 mt-1.5 sm:mt-2 text-xs sm:text-sm font-medium">Start collaborating with India&apos;s premium brand network.</p>
          </div>

          {/* Selector Tabs matching login role choices */}
          <div className="p-1 bg-foreground/5 border border-foreground/10 rounded-xl grid grid-cols-2 gap-1 mb-5 sm:mb-6">
            <button
              onClick={() => setRole("creator")}
              type="button"
              className={`py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-bold transition-all ${role === "creator" ? "bg-[#7C5CFF] text-foreground shadow-md shadow-[#7C5CFF]/20" : "text-foreground/50 hover:text-foreground"}`}
            >
              👤 Creator
            </button>
            <button
              ...
              type="button"
              className={`py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-bold transition-all ${role === "brand" ? "bg-[#7C5CFF] text-foreground shadow-md shadow-[#7C5CFF]/20" : "text-foreground/50 hover:text-foreground"}`}
            >
              🏢 Brand
            </button>
          </div>
          ...
          <button
            ...
            className="w-full bg-foreground/5 border border-foreground/10 py-2.5 sm:py-3 text-xs sm:text-sm font-bold text-foreground hover:bg-foreground/10 hover:border-foreground/20 transition-all flex items-center justify-center gap-2 rounded-xl shadow-[0_2px_4px_rgba(0,0,0,0.2)]"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-[10px] sm:text-xs uppercase tracking-widest font-black text-foreground/60 block mb-1 sm:mb-1.5">First Name</label>
                <input
                  ...
                  className="w-full bg-foreground/5 border border-foreground/10 rounded-xl px-3 py-2.5 sm:px-4 sm:py-3 text-xs sm:text-sm text-foreground placeholder-white/30 outline-none focus:border-[#7C5CFF]/60 focus:bg-[#13131F] transition-all"
                  placeholder="John"
                />
              </div>
              <div>
                <label className="text-[10px] sm:text-xs uppercase tracking-widest font-black text-foreground/60 block mb-1 sm:mb-1.5">Last Name</label>
                <input
            ...
            <div>
              <label className="text-[10px] sm:text-xs uppercase tracking-widest font-black text-foreground/60 block mb-1 sm:mb-1.5">Phone Number</label>
              <input
            ...
            <div>
              <label className="text-[10px] sm:text-xs uppercase tracking-widest font-black text-foreground/60 block mb-1 sm:mb-1.5">Password</label>
              <input
              ...
              />
              <p className="text-[10px] text-foreground/40 mt-1.5">Must be at least 8 characters</p>
            </div>
            ...
            <div className="flex items-start gap-2.5 mt-2">
              <input
                ...
                className="mt-1 flex-shrink-0 appearance-none w-4 h-4 border border-foreground/20 rounded bg-foreground/5 checked:bg-[#7C5CFF] checked:border-[#7C5CFF] relative cursor-pointer
              ...
              />
              <label htmlFor="terms" className="text-xs text-foreground/60 leading-tight">
          ...
          <p className="mt-6 sm:mt-8 text-center text-xs sm:text-sm text-foreground/60 font-semibold">
