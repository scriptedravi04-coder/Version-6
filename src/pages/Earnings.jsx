...
export default function Earnings() {
  ...
  // Calculate Totals using live data (or mock if no live data for now)
  const txDataSource = transactions.length > 0 ? transactions : MOCK_EARNINGS;
        ...
        <div className="xl:col-span-2 bg-[#1A1A24]/40 backdrop-blur-md border border-white/5 rounded-3xl p-6">
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%" minWidth={10} minHeight={10}>
              <BarChart data={MOCK_CHART_DATA} margin={{ top: 20, right: 0, left: -20, bottom: 0 }}>
