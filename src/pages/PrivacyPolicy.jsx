...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen py-16 px-4 max-w-4xl mx-auto">
      {/* Glow highlight */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#7C5CFF]/15 rounded-full blur-[140px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 space-y-12">
        ...
        <div className="text-center space-y-4">
          <motion.div
            ...
            className="w-14 h-14 rounded-2xl bg-[#7C5CFF]/10 border border-[#7C5CFF]/30 flex items-center justify-center mx-auto text-[#D9F111] shadow-[0_8px_24px_rgba(124,92,255,0.15)]"
          >
            <ShieldCheck size={28} />
          </motion.div>
        ...
        {/* Highlight Banner */}
        <div className="p-5 rounded-2xl bg-gradient-to-r from-card to-card border border-[#7C5CFF]/30 shadow-2xl flex gap-4 items-start">
          <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 shrink-0">
            <Lock size={18} />
          </div>
          <div>
            <h3 className="text-sm font-bold text-foreground uppercase tracking-wider">Escrow and Communication Confidentiality</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          ...
          <div className="bg-card border border-foreground/10 rounded-2xl p-6 hover:border-foreground/15 transition-all space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-[#7C5CFF]/10 text-[#7C5CFF] flex items-center justify-center">
                <Database size={16} />
              </div>
              <h3 className="text-sm font-bold uppercase tracking-wider text-foreground">1. Data Collected</h3>
            </div>
            <p className="text-xs text-foreground/50 leading-relaxed">
              We collect information that allows our marketplace matching to operate smoothly:
            </p>
            <ul className="space-y-2 text-xs text-foreground/75 pl-4 list-disc marker:text-[#7C5CFF]">
              <li>
                <strong className="text-foreground">Creator Profiles:</strong> Name, social links, location, category tags, language choices, rate card pricing, and profile picture.
              </li>
              <li>
                <strong className="text-foreground">Brand Representatives:</strong> Organisation name, corporate website, contact names, logo, and campaign deliverables.
              </li>
              <li>
                <strong className="text-foreground">Transactional Data:</strong> Chat logs, campaign submissions, escrow delivery URLs, and feedback reviews.
              </li>
            </ul>
          </div>
          ...
          <div className="bg-card border border-foreground/10 rounded-2xl p-6 hover:border-foreground/15 transition-all space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wider text-foreground">2. Process and Utility</h3>
            </div>
            <p className="text-xs text-foreground/50 leading-relaxed">
              We strictly process active user data for the core functions of the Ybex matching interface:
            </p>
            <ul className="space-y-2 text-xs text-white/75 pl-4 list-disc marker:text-[#D9F111]">
          ...
          <div className="bg-card border border-foreground/10 rounded-2xl p-6 hover:border-foreground/15 transition-all space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wider text-foreground">3. Information Access</h3>
            </div>
            <p className="text-xs text-foreground/50 leading-relaxed">
              Data visibility operates under a closed role-based ecosystem to protect user privacy:
            </p>
            <ul className="space-y-2 text-xs text-foreground/75 pl-4 list-disc marker:text-[#D1F23F]">
          ...
          <div className="bg-card border border-foreground/10 rounded-2xl p-6 hover:border-foreground/15 transition-all space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wider text-foreground">4. User Rights</h3>
            </div>
            <p className="text-xs text-foreground/50 leading-relaxed">
              You retain full, custom control over your personal profile parameters:
            </p>
            <ul className="space-y-2 text-xs text-foreground/75 pl-4 list-disc marker:text-emerald-400">
        ...
        <div className="bg-[#0D0D13] border border-foreground/5 rounded-3xl p-8 space-y-6 text-xs text-foreground/60 leading-relaxed">
          <h2 className="font-display text-foreground text-base font-bold uppercase tracking-wider">Cookie Policy and Technical Integration</h2>
          <p>
          ...
          <h2 className="font-display text-foreground text-base font-bold uppercase tracking-wider pt-2">Security Real-Time Auditing</h2>
          <p>
          ...
          <h2 className="font-display text-foreground text-base font-bold uppercase tracking-wider pt-2">Contact Ybex Support</h2>
          <p>
        ...
        <div className="text-center pt-4">
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-[#7C5CFF] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#6849E0] transition-all shadow-[0_4px_16px_rgba(124,92,255,0.25)] hover:scale-105"
          >
