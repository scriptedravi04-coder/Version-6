...
export default function BrandOnboardingFlow({ user, onComplete }) {
  ...
  const filteredNiches = VALID_NICHES.filter(n => n.toLowerCase().includes(nicheSearch.toLowerCase()));
  const filteredCities = INDIAN_CITIES.filter(n => n.toLowerCase().includes(citySearch.toLowerCase()));
