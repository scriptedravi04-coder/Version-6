         ...
         <div className="bg-[var(--bg-elevated)] p-6 relative overflow-hidden flex-shrink-0 border-b border-[var(--border-default)]">
           ...
           <div className="flex justify-between items-start mb-6">
              ...
              <div className="flex flex-col items-end">
                 <span className="text-[var(--text-tertiary)] text-[10px] font-bold uppercase tracking-widest mb-1.5 drop-shadow-sm">Estimated Budget</span>
                 <span className="text-sm font-black text-[var(--text-primary)] bg-[var(--bg-elevated)] px-3 py-1 rounded-xl border border-[var(--border-default)] shadow-inner whitespace-nowrap">₹{(c.budget_min || 10000).toLocaleString("en-IN")} - {(c.budget_max || 15000).toLocaleString("en-IN")}</span>
              </div>
           </div>
         ...
         <div className="bg-[var(--bg-card)] p-6 flex-1 flex flex-col justify-end">
           <div>
              ...
              <div className="flex justify-between items-center text-[10px] text-[var(--text-tertiary)] font-bold uppercase tracking-wider mt-4 border-t border-[var(--border-default)] pt-4 mb-4">
                 ...
                 <span className="text-[var(--text-primary)]">{c.deadline || "Jun 30, 2026"}</span>
              </div>
