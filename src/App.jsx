  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/brand/campaigns" element={<ProtectedRoute><Layout><Page><BrandCampaigns /></Page></Layout></ProtectedRoute>} />
        <Route path="/brand/campaigns/create" element={<ProtectedRoute><Layout><Page><BrandCampaignCreate /></Page></Layout></ProtectedRoute>} />
        <Route path="/brand/campaigns/:id/applicants" element={<ProtectedRoute><Layout><Page><BrandCampaignApplicants /></Page></Layout></ProtectedRoute>} />
